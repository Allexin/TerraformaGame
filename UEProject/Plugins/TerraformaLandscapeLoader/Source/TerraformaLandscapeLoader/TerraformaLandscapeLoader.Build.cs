...
{
    public class TerraformaLandscapeLoader : ModuleRules
    {
        public TerraformaLandscapeLoader(ReadOnlyTargetRules Target) : base(Target)
        {
            ...
            PublicIncludePaths.AddRange(new string[] { "TerraformaLandscapeLoader/Public" });
